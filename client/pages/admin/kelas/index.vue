  ...
  <div>
    ...
    <div class="card">
      ...
      <template v-else>
              ...
              <tr v-for="cls in classes" :key="cls.id">
                ...
                <td>
                  <div class="flex items-center gap-2">
                    <button class="text-brand-600 hover:text-brand-800 text-sm font-medium" @click="openEdit(cls)">Edit</button>
                    <button class="text-red-500 hover:text-red-700 text-sm font-medium" @click="handleDelete(cls)">Hapus</button>
                  </div>
                </td>
              </tr>
            </tbody>
        ...
        <AppEmpty v-else icon="🏫" title="Belum ada kelas" description="Tambahkan kelas pertama" />
