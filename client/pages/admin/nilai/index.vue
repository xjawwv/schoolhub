<template>
  <div>
    <div class="page-header">
      ...
      <p class="page-subtitle">Pantau data nilai seluruh siswa</p>
    </div>
    ...
    <div class="card">
      ...
      <template v-else>
        ...
        <AppEmpty v-else icon="📊" title="Belum ada data nilai" description="Data nilai akan muncul setelah guru melakukan input" />
...
const fetchSubjects = async () => {
  try {
    const response = await subjectsService.getAll({ limit: 100 })
